...
const CACHE = "deutsch-coach-v3.0.0";
const FILES = ["./", "index.html", "manifest.webmanifest", "css/app.css", "icons/icon-192.png", "icons/icon-512.png",
  "js/engine.js", "js/core.js", "js/tutor.js", "js/ui.js", "js/views1.js", "js/views2.js", "js/views3.js", "js/app.js",
  ...["curriculum", "reference", "scenes", "vocab", "verbs", "conj", "notes", "passages", "bank", "lid"].map((f) => `js/data/${f}.js`)];
